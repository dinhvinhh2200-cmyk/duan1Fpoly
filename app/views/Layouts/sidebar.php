...
$manageKeywords = [
    ...
    '/staff', 
    '/discount', 
    '/QrStaff',          // <-- Thêm dòng này
    '/AdminAttendance'   // <-- Thêm dòng này
];
    ...
    <ul class="list-unstyled components">
        ...
        <li class="<?php echo $isManageGroupActive ? 'active' : ''; ?>">
            ...
            <ul class="collapse list-unstyled <?php echo $isManageGroupActive ? 'show' : ''; ?>" id="homeSubmenu">
                ...
                <li class="<?php echo setActive('/QrStaff', $current_uri); ?>">
    <a href="<?php echo URLROOT; ?>/QrStaff">
        <i class="fas fa-users-cog me-2"></i> Quản lý NV Check-in
    </a>
</li>
                <li class="<?php echo setActive('/AdminAttendance', $current_uri); ?>">
    <a href="<?php echo URLROOT; ?>/AdminAttendance">
        <i class="fas fa-clipboard-check me-2"></i> Thống kê chuyên cần
    </a>
</li>
            </ul>
        </li>
