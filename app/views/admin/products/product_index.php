   ...
   <?php require_once APPROOT . '/views/Layouts/sidebar.php'; ?>
    ...
    <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm px-3 mb-3">
            ...
            <span class="navbar-brand mb-0 h1 fw-bold text-primary ms-3">☕ QUẢN LÝ MÓN </span>
        </nav>
                            ...
                            <div class="mb-3">
                                ...
                                <?php if(isset($_SESSION['error_product_name'])): ?>
                                    <div class="text-danger small mt-1 fw-bold">
                                        ...
                                        <?php 
                                            echo $_SESSION['error_product_name']; 
                                            unset($_SESSION['error_product_name']); 
                                        ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <?php if(isset($_SESSION['error_product_price'])): ?>
                                    <div class="text-danger small mt-1 fw-bold">
                                        <i class="fas fa-exclamation-triangle me-1"></i> 
                                        <?php 
                                            echo $_SESSION['error_product_price']; 
                                            unset($_SESSION['error_product_price']); 
                                        ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody id="productTableBody">
                                    <?php if(!empty($data['products'])): ?>
                                        ...
                                        <tr class="table-row <?php echo ($product->is_deleted == 1) ? 'table-secondary text-muted' : ''; ?>" 
                                            onclick='<?php echo ($product->is_deleted == 0) ? 'selectProduct(this, ' . htmlspecialchars(json_encode($product), ENT_QUOTES, 'UTF-8') . ')' : ''; ?>'>
                                            ...
                                            <td class="text-center">
                                                <?php if($product->image): ?>
                                                    <img src="<?php echo URLROOT . '/public/uploads/' . htmlspecialchars($product->image); ?>" 
                                                        class="thumb-img" style="width: 40px; height: 40px; object-fit: cover; filter: <?php echo ($product->is_deleted == 1) ? 'grayscale(100%)' : 'none'; ?>;">
                                                <?php else: ?>
                                            ...
                                            <td class="text-danger fw-bold"><?php echo number_format($product->price); ?></td>
                                            
                                            <td>
                                                <?php if($product->is_deleted == 1): ?>
                                                    <a href="<?php echo URLROOT; ?>/product/restore/<?php echo $product->product_id; ?>" 
                                                       class="btn btn-sm btn-success fw-bold text-white btn-restore" 
